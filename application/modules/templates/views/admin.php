                ...
                <div id="sidebar-left" class="span2">
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            <li><a href="index.html"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Hello</span></a></li>	
                            <li><a href="<?php echo base_url() . "roleholder_list/main" ?>"><i class="icon-envelope"></i><span class="hidden-tablet"> Roles </span></a></li>
